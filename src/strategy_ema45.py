...
class Strategy(StrategyBase):
    """Long-only EMA(45) trend strategy discovered from optimisation."""

    metadata = StrategyMetadata(
        name="ema45",
        description="Versi EMA hasil optimasi yang menggunakan EMA45 sebagai filter tren.",
        entry="Entry long ketika penutupan di atas EMA45.",
        exit="Keluar ketika penutupan kembali di bawah EMA45.",
        parameters={"ema_length": 45},
        context_columns=("price", "ema", "position"),
    )

    def __init__(self, ema_length: int = 45, price_column: str = "close") -> None:
